...
export default function RepoSelect(repo : {reposfromDB: ReposFromDB}) {
  ...
  <div className='flex flex-col items-center'>
    ...
    <section className='flex flex-wrap gap-4 w-full h-full md:grid md:grid-cols-3'>
        {reposfromDB?.map((repo, i) => (
          <HoverCard key={i}>
            <HoverCardTrigger className='w-full h-fit'>
              <Dialog>
                ...
                <DialogContent className='w-full max-w-4xl px-8 py-10'>
                  <DialogHeader>
                    <DialogTitle className='font-montserrat font-black flex items-center justify-between'>
      ...
      <Button className='w-full px-10 md:w-fit bg-blsm_secondary hover:brightness-75 hover:bg-blsm_secondary'>Update</Button>
      <Button className='w-full px-4 md:w-fit bg-transparent border-red-400 border-2 text-white hover:bg-red-300'>Delete</Button>     
      </div>
                    </DialogTitle>
            ...
            <HoverCardContent className=' hidden w-full md:block'>
              <p className='text-center text-sm font-black w-full'>Updates</p>
              <ul className='flex flex-col gap-2'>
                {repo.Updates.map((update, i) => (
                  <li key={i} className='flex flex-col gap-1'>
