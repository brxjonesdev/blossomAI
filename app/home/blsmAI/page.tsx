    ...
    },
    {
      ...
      issues: [
        ...
        },
        {
          ...
          description: 'Allow users to export data from the application to CSV format',
          status: 'closed',
      ...
      commits: [
        ...
        },
        {
          ...
          description: 'Updated project dependencies to the latest compatible versions',
          status: 'closed',
      ...
      pull_requests: [
        {
          ...
          description: 'Implement search functionality for better data discovery',
          status: 'open',
      ...
      commits: [
        {
          ...
          description: 'Implemented lazy loading for images to improve page load times',
          status: 'open',
    ...
    },
    {
      ...
      pull_requests: [
        ...
        },
        {
          ...
          description: 'Add functionality to assign different roles and permissions to users',
          status: 'closed',
      ...
      commits: [
        ...
        },
        {
          ...
          description: 'Updated third-party libraries to address security vulnerabilities',
          status: 'closed',
  ...
  return (
    <section className='font-montserrat border-2 grow rounded-md flex p-4 items-center flex-col gap-2 pt-8'>
      <h1 className='font-montserrat font-black text-xl md:text-3xl max-w-[600px] '>
        You have <span className='text-blsm_primary'>{totalPullRequests} pull requests</span>, <span className='text-blsm_secondary'>{totalIssues} issues</span>, & <span className='text-blsm_accent'>{totalCommits} commmits</span> across {totalRepos} repositories.
      </h1>
      <p className='font-cabin'>
        Select which repository you would like to view updates for.
      </p>
      <section className='flex flex-col gap-4 md:grid md:grid-cols-3 md:mt-6 w-full'>
  {reposfromDB.map((repo, i) => (
    <div key={i} className='flex flex-col gap-2 border-2 w-full p-2 rounded'>
      <h2 className='font-montserrat font-bold text-lg'>{repo.name}</h2>
      <p className='font-cabin'>
        {repo.pull_requests.length} pull requests, {repo.issues.length} issues, {repo.commits.length} commits
      </p>
    </div>
  ))}
</section>
